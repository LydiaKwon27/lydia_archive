...
const TRANSLATIONS = {
    ko: {
        ...
        heroHeadline: '웹에서 앱으로, 끊기지 않는 유저 여정을 만듭니다 | B2B SaaS Sales | AdTech X MarTech',
        ...
        aboutP1: 'K-뷰티 브랜드의 글로벌 영업 환경에서 커리어를 시작했습니다. 해외 바이어와의 단가 협상, 거래 체결, 물류 및 선적 관리까지 경험하며 B2B 영업이 실제 비즈니스로 연결되는 과정을 가까이에서 배웠습니다.',
        aboutP2: '이후 AI 기반 SaaS 제품의 B2B 인사이드 세일즈를 경험하며 콜드콜을 통해 잠재 고객을 발굴하고, 초기 접점에서 고객과 대화를 만드는 경험을 했습니다. 이 경험을 통해 단순히 제품을 설명하는 일이 아니라 고객의 비즈니스 구조와 문제를 이해하는 세일즈 역량을 기를 수 있었습니다.',
        aboutP3: '현재는 빠르게 변화하는 MarTech 시장에서 Inside Sales 경험을 기반으로 Field Sales 역량을 확장하고 있습니다. 기능 중심의 설명을 넘어, 고객의 비즈니스 구조와 시장 흐름을 함께 이해하고 성장 전략을 고민하는 세일즈를 지향합니다.',
        aboutP4: '또한 AI를 활용한 콘텐츠 제작, 바이브 코딩을 통한 데이터 대시보드 실험, 커리어와 산업에 대한 인사이트 기록 등을 통해 세일즈 직무에 국한되지 않고 시장·데이터·기술에 대한 시야를 함께 넓히고 있습니다.',
        aboutP5: 'AI가 빠르게 시장을 바꾸고 있습니다. 고객의 비즈니스 구조가 달라지고, 소비자의 행동도 계속 변화하고 있습니다.<br>저는 이러한 변화를 읽고, 고객의 성장을 함께 고민하며 실질적인 해결책을 제시하는 세일즈 컨설턴트로 성장하고자 합니다.',
    ...
    en: {
        ...
        aboutP1: 'I started my career in the global sales environment of a K-beauty brand, where I gained hands-on experience in B2B sales. I worked closely with overseas buyers on price negotiations, deal closures, and logistics and shipment coordination, which gave me a practical understanding of how B2B sales translate into real business operations.',
        aboutP2: 'I later moved into B2B inside sales for an AI-based SaaS product, where I conducted cold calls and sourced potential customers. Through these early conversations with prospects, I began to see that sales is not just about explaining a product, but about understanding a customer\'s business structure and challenges.',
        aboutP3: 'Today, I am expanding my experience toward Field Sales within the fast-changing MarTech landscape, building on my background in inside sales. Rather than focusing only on product features, I try to understand how a customer\'s business works and how technology can support their growth.',
        aboutP4: 'Outside of day-to-day sales work, I\'m also interested in the broader ecosystem around it. I experiment with AI to create content, build simple data dashboards through vibe coding, and regularly write about career and industry insights. These efforts help me broaden my perspective beyond sales itself into market, data, and technology.',
        aboutP5: 'AI is rapidly reshaping the market. Business models are evolving, and consumer behavior continues to change.<br>I aim to grow into a sales consultant who understands these shifts, helping customers navigate change and find practical ways to grow their business.',
        aboutRole: 'Sales Associate | B2B SaaS MarTech | Airbridge',
